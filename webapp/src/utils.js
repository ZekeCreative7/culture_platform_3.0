...
const QUESTION_SETS = {
  팀빌딩: {
    ...
    사후: [
      { id: "q1",  type: "quant", text: "이번 팀빌딩 세션 이후, 우리 팀의 전반적인 분위기가 이전보다 긍정적으로 변화했다고 느낀다." },
      { id: "q2",  type: "quant", text: "이번 세션을 통해 내 몸과 감정 상태를 먼저 알아차리는 것이 실제로 도움이 된다는 것을 경험했다." },
      { id: "q3",  type: "quant", text: "이번 세션 이후, 우리 팀에서 서로 다른 의견을 말하는 것이 이전보다 더 안전하게 느껴진다." },
      { id: "q4",  type: "quant", text: "이번 세션 이후, 우리 팀에서 실수나 어려움을 더 편하게 공유하고 도움을 요청할 수 있겠다고 느낀다." },
      { id: "q5",  type: "quant", text: "이번 세션 이후, 우리 팀이 서로의 의견을 존중하며 대화할 수 있는 분위기를 함께 만들 수 있겠다고 느낀다." },
      { id: "q6",  type: "quant", text: "이번 세션을 통해 피로하거나 감정이 올라올 때 잠시 멈추고 가라앉히는 방법이 실제로 도움이 되었다." },
      { id: "q7",  type: "quant", text: "이번 세션 이후, 우리 팀이 변화가 생겼을 때 함께 조정해보려는 분위기가 이전보다 강해졌다고 느낀다." },
      { id: "q8",  type: "quant", text: "이번 세션 이후, 우리 팀에서 서로의 생각이나 일하는 방식이 다를 수 있다는 것을 이전보다 더 잘 이해하게 되었다." },
      { id: "q9",  type: "quant", text: "이번 세션 이후, 우리 팀이 대화할 때 상대방에게 잘 전달되도록 더 신경 쓰게 되었다." },
      { id: "q10", type: "quant", text: "이번 세션을 통해 우리 팀이 더 건강하게 소통하고 협업하기 위한 작은 행동을 함께 만들 수 있겠다고 느낀다." },
